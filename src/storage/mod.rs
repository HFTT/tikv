...
impl<E: Engine, L: LockManager> Storage<E, L> {
    ...
    pub fn get(
        ...
        let res = self.read_pool.spawn_handle(
            ...
            .with_scope(Scope::from_local_parent("Storage::get")),
            priority,
            thread_rng().next_u64(),
        );
        async move {
    ...
    ) -> impl Future<Output = Result<Vec<Result<(Option<Vec<u8>>, Statistics, PerfStatisticsDelta)>>>>
    {
        ...
        let res =
            self.read_pool.spawn_handle(
                ...
                .with_scope(Scope::from_local_parent("Storage::batch_get_command")),
                priority,
                thread_rng().next_u64(),
            );
        async move {
    ...
    pub fn batch_get(
        ...
        let res = self.read_pool.spawn_handle(
            ...
            .with_scope(Scope::from_local_parent("Storage::batch_get")),
            priority,
            thread_rng().next_u64(),
        );
    ...
    pub fn scan(
        ...
        let res = self.read_pool.spawn_handle(
            ...
            .with_scope(Scope::from_local_parent("Storage::scan")),
            priority,
            thread_rng().next_u64(),
        );
